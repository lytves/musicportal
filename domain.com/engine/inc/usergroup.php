...
<table width="100%">
    ...
    <tr>
        <td style="padding:4px;" class="option"><b>Разрешить пользователям выставлять рейтинг трекам</b><br /><span class="small">Если Да то пользователи смогут голосовать за треки путём выставления рейтинга.</span></td>
	...
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>Разрешить пользователям скачивать треки</b><br /><span class="small">Если Да то пользователи смогут скачивать треки из музыкального архива.</span></td>
	...
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>Прежде чем скачать трек необходимо ввести защитный код</b><br /><span class="small">Если Да то прежде чем начнётся скачивание трека пользователю будет предложено ввести защитный код с изображения. Настройка не имеет значения если Вы отключили группе скачивание треков.</span></td>
	...
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>Разрешить пользователям добавлять треки в архив</b><br /><span class="small">Если Да то пользователи смогут добавлять свои треки в музыкальный архив.</span></td>
	...
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>Отображать защитный код перед добавлением трека в архив</b><br /><span class="small">Если Да то в форме добавления нового трека в архив будет предложено ввести защитный код.</span></td>
	...
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>После добавления трека отправлять его на модерацию</b><br /><span class="small">Если Да то после добавления трека пользователем он будет отправлен на модерацию, если Нет то трек будет сразу опубликован в музыкальном архиве.</span></td>
