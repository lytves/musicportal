...
'descr'      => "Управление публикациями, категориями и настройками музыкального архива сайта",
...
HTML;
	...
	showRow( 'Короткое название - для ссылки в футере на саму себя страницу', 'Часть от верхнего Названия сайта', "<input class=edit type=text style=\"text-align: center;\" name=\"save_con[home_title_short]\" value=\"{$config['home_title_short']}\" size=40>" );
