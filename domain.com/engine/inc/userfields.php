...
<?php
      ...
      default:
        echoheader("options", "ƒополнительные пол€");
?>
<form action="<? echo $_SERVER["PHP_SELF"]; ?>" method="post" name="xfieldsform">
<input type="hidden" name="mod" value="userfields">
<input type="hidden" name="user_hash" value="<? echo $dle_login_hash; ?>">
...
<tr>
<td>$value[1]:</td>
<td class="xprofile" colspan="2"><input class="f_input" style="border: 1px solid #9ca0a1; height: 20px;" type="text" name="xfield[$fieldname]" id="xfield[$fieldname]" value="$fieldvalue" /></td>
</tr>
HTML;
...
<tr>
<td>$value[1]:</td>
<td class="xprofile"><input type="text" name="xfield[$fieldname]" id="xfield[$fieldname]" value="$fieldvalue" />
</tr>
HTML;
      } elseif ($value[3] == "select") {
