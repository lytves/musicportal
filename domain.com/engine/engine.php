...
//# Static main - добавлена загрузка муз.модуля, если страница главная!!!!!!!!, убрана возможность публиковать новости на главной,
//# таким образом на главной выводится только музыкальный модуль, а новости доступны в категориях

if (($_SERVER['QUERY_STRING']=="") OR $_REQUEST['action']) include_once ENGINE_DIR . '/modules/mservice/mservice.php';
// это для тестов (изменения от 01.07.2014)
...
switch ( $do ) {   
  ...
  case "account_connect" :
	...
	*/
	...
	break;
	// самоделка для формы входа на сайт
	case "enter" :
