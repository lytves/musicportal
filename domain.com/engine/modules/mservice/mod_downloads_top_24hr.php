...
if (intval($num_downloads_top_24hr)) {
  $metatags['title'] = 'Топ скачиваний mp3 треков за сутки (ТОП '.$num_downloads_top_24hr.') на '.$config['home_title_short'];
  $metatags['description'] = 'Топ скачиваний mp3 треков за сутки (ТОП '.$num_downloads_top_24hr.') на '.$config['description'];
  $metatags['keywords'] = 'топ скачиваний, мп3 трек, топ '.$num_downloads_top_24hr.', музыкальный архив mp3, '.$config['keywords'];
}
...
<tr>
<th colspan="5"><h3 class="tit_green"><a href="/music/downloadstop24hr.html" title="Топ скачиваний mp3 треков за сутки" style="color:#3367AB;">Топ скачиваний mp3 треков за сутки</a> (ТОП '.$num_downloads_top_24hr.')</h3></th>
</tr></table>
<table>
<tr><td colspan="5">
<div class="bestmp3">...а также Топ скачиваний mp3 треков за: <ul class="bestmp3s"><li><a style="margin-left:10px;" href="/music/downloadstopweek.html" title="Топ скачиваний mp3 треков за неделю">неделю</a></li></ul></div>
</td></tr>
<tr>
...
<td align="center">'.formatsize( $query_downloads_top_24hr[$i]['size'] ).'</td>';
	...
	$downloads_top_24hr .= '<td align="center"><a href="'.$t_link.'" title="Скачать '.$query_downloads_top_24hr[$i]['artist'].' - '.$query_downloads_top_24hr[$i]['title'].' mp3"><div class="download_tracklist"></div></a></td></tr>';
}
$downloads_top_24hr .= '</table></div>';

} else $downloads_top_24hr = 'Меньше 10 скачиваний mp3 треков за сутки!';
?>