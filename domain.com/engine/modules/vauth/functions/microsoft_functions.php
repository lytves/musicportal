...
if( ! class_exists( 'MsFunctions' ) )	{
	...
	class MsFunctions extends VAuthFunctions {
		...
		function oauth_data() {
			...
			if (empty($oauth['app_id'])) die('Unknown Application ID Microsoft Live');
			if (empty($oauth['app_secret'])) die('Unknown Application ID Microsoft Live');
      ...
      ///// вместо верхних закомментированных строк вставил эту
			$oauth['avatar'] 		=	'https://apis.live.net/v5.0/'.$oauth['uid'].'/picture';
