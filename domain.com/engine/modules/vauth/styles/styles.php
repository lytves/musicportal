<?PHP
	...
	// ** Вид кнопочек сопряжения аккаунтов (стили находятся в шаблоне ac_connect.tpl)
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text[11].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text[13].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text[142].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_fs'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_od'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_in'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_go'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_ms'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_ma'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_gh'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect_off" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['di_ya'].'</span></button>
		</form>';
		...
		'<form  method="post" name="ac_connect">
			...
			<button class="dle_connect" onclick="ShowLoading(\'\');document.getElementById(\'ac_connect\').style.display=\'none\';submit();" type="submit" title="Выполнить"><span>'.$vauth_text['en_ya'].'</span></button>
		</form>';
