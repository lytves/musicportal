...
if ($user['user_group'] != 1) die; 
			...
			<div class="settings">
				...
				if (file_exists($func_path . '/yandex_functions.php')) $settings = $settings.'
					<div class="settings_list">
						<div class="input_text">yandex app id</div>
						<input class="settings_input" name="save_con[yandex_app_id]" value="'.$vauth_config['yandex_app_id'].'">

						<div class="input_text">yandex Пароль</div>
						<input class="settings_input" name="save_con[yandex_app_secret]" value="'.$vauth_config['yandex_app_secret'].'">
						
						<div class="input_text">Группа пользователя из Yandex:</div>
						'.createSelectForSocial($vauth_config['yandex_user_group'],'yandex_user_group').'
					</div>';	
