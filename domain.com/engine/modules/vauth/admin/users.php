...
if ($user['user_group'] != 1) die; 
	...
	$id = $_GET['del_user'];
			...
			if (file_exists($func_path . '/yandex_functions.php')) $selectlist = $selectlist.'<option  value="yandex">yandex</option>';
			//if (file_exists($func_path . '/steam_functions.php')) $selectlist = $selectlist.'<option  value="steam">steam</option>';
			
			
			$vauth_search = '
			<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script>
			<script type="text/javascript" src="engine/skins/calendar_9-5.js"></script>
			...
			<tr>
				...
				<td style="padding-left:2px;"><select name="sort" id="search_order_u">
				   <option value="">'.$vauth_text['admin_searchform_nd'].'</option>
				   <option selected value="desc">'.$vauth_text['admin_searchform_nu'].'</option>
					</select>
				</td>
				...
				<td style="padding-left:2px;" ><select name="reg" id="search_order_c">
				   <option  value="">'.$vauth_text['admin_searchform_allt'].'</option>
				   <option selected value="24">'.$vauth_text['admin_searchform_24h'].'</option>
