...
function fileQueueError(file, errorCode, message) {
	try {
		if (errorCode === SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED) {
			alert("Вы выбрали слишком много файлов.\n" + (message === 0 ? "Вы превысили лимит." : "Вы можете выбрать " + (message > 1 ? "не более " + message + " файлов." : "один файл.")));
			return;
		}
		...
		case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
			progress.setStatus("Невозможно загрузить файл нулевого размера.");
...
function uploadError(file, errorCode, message) {
	try {
		...
		case SWFUpload.UPLOAD_ERROR.HTTP_ERROR:
			progress.setStatus("Ошибка: " + message);
		...
		case SWFUpload.UPLOAD_ERROR.FILE_VALIDATION_FAILED:
			progress.setStatus("Ошибка идентификации.  Загрузка пропущена.");
