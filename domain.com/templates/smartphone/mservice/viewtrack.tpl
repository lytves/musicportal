...
<div class="mservice_viewtrack">
    <center>
        <a href="{downloadlink}" style="hover text-decoration:underline;" title="скачать {artist} - {title} мп3"><img src="{THEME}/images/download_big.png" title="download mp3, скачать бесплатно mp3 {artist} - {title}" alt="{artist} - {title}" style="display:block;"><b>Скачать бесплатно mp3 файл {artist} - {title}</b></a>
    </center>
</div>
