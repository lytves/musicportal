...
<p></p><b style="margin-left:10px;">&raquo; О пользователе. Связь</b>
<div class="line" style="margin-bottom:5px;"></div>
        ...
        <table width="90%" class="text" style="margin-left:15px;">
                ...
                <tr valign="middle">
                  ...
                  <td height="25" width="443">
					...
					<br />
					<font style="color:#FF0000;font-size:10px">* Внимание! Будьте бдительны при изменении данной настройки. Доступ к вашему аккаунту будет доступен только с того IP адреса или подсети, который вы укажите. Пример: 192.48.25.71 или 129.42.*.*</td>
                </tr>
                </tr>
                <tr valign="middle">
                  <td width="133" height="10"> </td>
