...
<body>
            ...
            <tr>
                    ...
                    <div id="content" style="height:100%;">
                        <noindex>
                            <div class="adv">
                                ...
                                [not-aviable=static]{banner_adv_center}[/not-aviable]
                            </div>
                        </noindex>
                ...
                <td valign="top" width="248" rowspan="2">
                    ...
                    <div class="box">
                        <noindex>
                            <div class="adv">
                                [not-aviable=static]{banner_adv_right_vertical}[/not-aviable]
                            </div>
                        </noindex>
                    </div>
        ...
        <table border="0" width="1000">
            <tr>
                <td>
                    ...
                    <div class="line"></div>
                    <div style="text-align:center; padding-bottom:10px;"><a href="/index.php?action=mobile">перейти на мобильную версию сайта</a></div>
                </td>
            </tr>
        </table>
    ...
    <noindex>
        ...
        <!--/noindex-->[/not-group] [not-group=1,7]
        <!--noindex-->
        <script type="text/javascript" src="//am15.net/bn.php?s=69892&f=3&d=8969"></script>
        <!--/noindex-->[/not-group]
    </noindex>
